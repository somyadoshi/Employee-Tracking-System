...
CREATE PROCEDURE uspInsertTeam_Employee
  @S_Date DATE,
  @E_Date DATE,
  @T_Name_1 VARCHAR(50),
  @D_Name_2 VARCHAR(50),
  ...
  BEGIN TRANSACTION T
    INSERT INTO tblTeam_Employee (TeamID, EmployeeID, RoleID, StartDate, EndDate)
    VALUES (@T_ID_1, @E_ID_1, @R_ID_1, @S_Date, @E_Date)
  IF @@ERROR <> 0
